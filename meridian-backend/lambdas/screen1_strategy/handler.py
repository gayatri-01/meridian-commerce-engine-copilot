...
from shared.agent_service import run_strategy_agent
...
def lambda_handler(event, context):
    ...
    query = body.get(
        "query",
        "Provide a retail opportunity report for the next 15 days in Dombivli.",
    )
    ...
    try:
        ...
        return response(500, {"error": str(exc), "source": "screen1_strategy"})
